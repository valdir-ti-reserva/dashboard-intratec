    ...
    <div className="grid">
      ...
      <aside className="sidenav">
        <div className="sidenav__brand">
          ...
          <a className="sidenav__brand-link" href="#">Intratec<span className="text-light">Tecnologia</span></a>
          <i className="fas fa-times sidenav__brand-close"></i>
        </div>
        <div className="sidenav__profile">
          <div className="sidenav__profile-avatar"></div>
          <div className="sidenav__profile-title text-light">Valdir Silva</div>
        </div>
        ...
        <div className="main-header">
          <div className="main-header__intro-wrapper">
            <div className="main-header__welcome">
              <div className="main-header__welcome-title text-light">Welcome, <strong>Valdir</strong></div>
      ...
      <footer className="footer">
        <p><span className="footer__copyright">&copy;</span> 2022 Intratec Tecnologia</p>
        <p>Crafted&nbsp;<i className="fas fa-heart footer__icon"></i>by&nbsp;<a href="https://www.linkedin.com/in/valdirti/" target="_blank" className="footer__signature" rel="noreferrer">Valdir Silva
          </a>
        </p>
      </footer>
    </div>
